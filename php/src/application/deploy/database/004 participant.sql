...
(
    ...
    `invited` MEDIUMINT UNSIGNED NOT NULL COMMENT "Invited participant",
    ...
    `status` ENUM('creator', 'pending', 'invited', 'accepted', 'rejected') NOT NULL COMMENT "Participant status",

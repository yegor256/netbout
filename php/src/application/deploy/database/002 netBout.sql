...
(
    ...
    `id` MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT "Unique ID of the NetBout",
    ...
    `user` MEDIUMINT UNSIGNED NOT NULL COMMENT "Creator of this NetBout",

    `subject` TEXT NOT NULL COMMENT "Mandatory title of the bout, visible to all participants",
